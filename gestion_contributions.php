...
?>
	...
	<div class="form-block">
						<TABLE id="infoline" width="100%">
							<TR>
								<TD class="left"><? echo $nbcotis->fields[0]." "; if ($nbcotis->fields[0]!=1) echo _T("contributions"); else echo ("modificación"); ?></TD>
...
?>
	...
	&nbsp;&nbsp;&nbsp;
	<A href="ajouter_contribution.php?id_adh=<? echo $_SESSION["filtre_cotis_adh"]; ?>"><? echo ("[ Agregar una modificación ]"); ?></A>
<?
		}	
?>
		</DIV>
