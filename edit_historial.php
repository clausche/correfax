...
<H1 class="subtitre"> Historial (<? if ($id_adh!="") echo ("edición"); else echo ("creación"); ?>)</H1>
<FORM action="edit_historial.php" method="post" enctype="multipart/form-data">
...
?>
	...
	<TABLE border="0" id="input-table" width="800">
        ...
        <TR>
          <TH colspan="4" class="espacio">Historial</TH>
        </TR>

        <TR>

          <TD colspan="4" ><?php
$oFCKeditor = new FCKeditor('pays_adh') ;
$oFCKeditor->BasePath = 'fckeditor/';
$oFCKeditor->ToolbarSet = 'MitoolBar';
$oFCKeditor->Value = html_entity_decode($pays_adh);
$oFCKeditor->Create() ;
?></TD>
        </TR>
