...
<H1 class="subtitre"><? echo ("Terminos"); ?> (<? if ($id_adh!="") echo ("edición"); else echo ("creación"); ?>)</H1>
<FORM action="edit_terminos.php" method="post" enctype="multipart/form-data">
...
?>
	...
	<TABLE border="0" id="input-table" width="800">
        ...
        <TR>
          <TH colspan="4" class="espacio">Terminos</TH>
        </TR>

        <TR>

          <TD colspan="4" ><?php
$oFCKeditor = new FCKeditor('ter_adh') ;
$oFCKeditor->BasePath = 'fckeditor/';
$oFCKeditor->ToolbarSet = 'MitoolBar';
$oFCKeditor->Value = html_entity_decode($ter_adh);
$oFCKeditor->Create() ;
?></TD>
        </TR>
