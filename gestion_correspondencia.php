...
?>
			...
			<TH  width="75" class="listing left">
				<A href="gestion_correspondencia.php?tri=3" class="listing"><? echo ("País"); ?></A>
<?php
...
<?
			...
			{
?>
			<TH width="55" class="listing"><? echo ("Acción"); ?></TH>
...
/*		// définition CSS pour correspondencia désactivé
