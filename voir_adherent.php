...
<?
			...
			{
?>
	<A onClick="return confirm('<? echo str_replace("\n","\\n",addslashes("¿ Está a punto de borrar este Acuerdo:" .
				" ".$nom_adh." ?.\n\n Quiere seguir con la operación ?")); ?>')" href="gestion_correspondencia.php?sup=
...
?>
	<tr>
        <td colspan="2" align="center"><b>No tiene archivos guardados aún</b></td></tr>
<?
	}
	else {
?>
