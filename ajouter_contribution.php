...
<H1 class="subtitre"><? echo ("Ficha modificación"); ?> (<? if ($id_cotis!="") echo ("Edición"); else echo ("creación"); ?>)</H1>
...
?>						
						...
						<table border="0" id="input-table"> 
							<tr> 
								...
								<tr>
								<TH id="libelle" <? echo $id_type_cotis_req ?>><? echo ("Tipo de modificación :"); ?></TH> 
								<td>
