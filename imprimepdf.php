...
htmlspecialchars($html, ENT_COMPAT, 'UTF-8');
global $fecha;
	//Pie de página
	$this->SetY(-15);
...
$pdf=new PDF();
$title_decode = "Criptograf&iacute;a";
$title=html_entity_decode($title_decode);
$pdf->SetTitle($title);
$pdf->AddPage();
...
$pdf->Cell(95,6,html_entity_decode("Regi&oacute;n:")." ".$region_adh."",1);
	...
	$result->Close();
$pdf->Cell(95,6,html_entity_decode("Pa&iacute;s:")." ".$nombre_pais."",1);
$pdf->Ln();
$pdf->Cell(95,6,html_entity_decode("Organizaci&oacute;n Multilateral:")." ".$multi_adh."",1);
...
$pdf->Ln();
$pdf->Cell(60,6,html_entity_decode("Fecha suscripci&oacute;n:")." ".$date_crea_adh."",1);
...
$pdf->Ln(4);
$pdf->PrintChapter(html_entity_decode('&Uacute;ltimas actividades'));
$pdf->SetFont('Arial','',9);
$pdf->SetTextColor(0,0,0);
