...
<?
		...
		// filtre d'affichage des correspondencia activés/desactivés
		if ($_SESSION["filtre_adh_2"]=="1")
		{
			$requete[0] .= "AND ".PREFIX_DB."correspondencia.activite_adh='1' ";
			$requete[1] .= "AND ".PREFIX_DB."correspondencia.activite_adh='1' ";
		}
		if ($_SESSION["filtre_adh_2"]=="2")
		{
			$requete[0] .= "AND ".PREFIX_DB."correspondencia.activite_adh='0' ";
			$requete[1] .= "AND ".PREFIX_DB."correspondencia.activite_adh='0' ";
		}

		// filtre d'affichage des correspondencia à jour
		...
		// filtre d'affichage des correspondencia retardataires
		...
		// filtre d'affichage des correspondencia bientot a echeance
...
?>
		...
		<TABLE id="infoline" width="100%">
			<TR>
				...
				<TD class="right">
					<DIV id="listfilter">
						<FORM action="mailing_correspondencia.php" method="get" name="filtre">
						 	<? echo _T("Afficher :"); ?>&nbsp;
...
<?
		...
		{
?>
						<FORM action="etiquettes_correspondencia.php" method="post" name="mailing_form" target="_blank">
<?
		}
		else
		{
?>
						<FORM action="mailing_correspondencia.php" method="post" name="mailing_form">
<?
		}
?>
						<table width="100%"> 
							...
							<TH class="listing" width="15">#</TH> 
				  			<TH class="listing left" width="250"> 
								...
								<TH class="listing left"> 
									<A href="mailing_correspondencia.php?tri=1" class="listing"><? echo _T("E-Mail"); ?></A>
									<?
										if ($_SESSION["tri_adh"]=="1")
											if ($_SESSION["tri_adh_sens"]=="0")
												echo "<IMG src=\"images/asc.png\" width=\"7\" height=\"7\" alt=\"\">";
								...
								<TH class="listing left"> 
									<A href="mailing_correspondencia.php?tri=2" class="listing"><? echo _T("Statut"); ?></A>
									<?
...
?>
								<TD>
									<FORM action="mailing_correspondencia.php" method="post">
<?
			reset($mailing_adh);
			while(list($key,$value)=each($mailing_adh))
			{
...
?>
								<TD>
									<FORM action="gestion_correspondencia.php" method="post">
										<INPUT type="submit" value="<? echo _T("Retour"); ?>">
									</FORM>
								</TD>
<?
...
?>								
								<TD>
									<FORM action="etiquettes_correspondencia.php" method="post" target="_blank">
<?
		reset($nomail_adh);
