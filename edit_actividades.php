...
<H1 class="subtitre">Actividades (<? if ($id_adh!="") echo ("edición"); else echo ("creación"); ?>)</H1>
<FORM action="edit_actividades.php" method="post" enctype="multipart/form-data">
...
?>
	...
	<TABLE border="0" id="input-table" width="800">
        ...
        <TR>
          <TH colspan="4" class="espacio">Últimas actividades</TH>
        </TR>
                <TR>

          <TD colspan="4"><?php
$oFCKeditor = new FCKeditor('ville_adh') ;
$oFCKeditor->BasePath = 'fckeditor/';
$oFCKeditor->ToolbarSet = 'MitoolBar';
$oFCKeditor->Value = html_entity_decode($ville_adh);
$oFCKeditor->Create() ;
?></TD>
        </TR>
