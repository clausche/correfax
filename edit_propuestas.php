...
<H1 class="subtitre"> Propuestas (<? if ($id_adh!="") echo ("edición"); else echo ("creación"); ?>)</H1>
<FORM action="edit_propuestas.php" method="post" enctype="multipart/form-data">
...
?>
	...
	<TABLE border="0" id="input-table" width="800">
        ...
        <TR>
          <TH colspan="4" class="espacio">Propuestas</TH>
        </TR>
        <TR>

          <TD colspan="4" ><?php
$oFCKeditor = new FCKeditor('pro_adh') ;
$oFCKeditor->BasePath = 'fckeditor/';
$oFCKeditor->ToolbarSet = 'MitoolBar';
$oFCKeditor->Value = html_entity_decode($pro_adh);
$oFCKeditor->Create() ;
?>
         <DIV class="exemple">Resúmen de la Propuesta</DIV></TD>
        </TR>
