...
?>
	...
	<DIV id="copyright">
		<A href="http://localhost/"><? echo LAUTARO_VERSION ?></A> - Autor :  <A href="mailto:clausche@gmail.com"><? echo AUTOR ?></A> - <? echo _T("Page affichée en")." ".substr($run, 0, 5)." "._T("secondes."); ?>
	</DIV>
	</DIV>
</DIV>
...
<div style="float:left; margin-left:0px;"> <!--This is the second division of right-->
  ...
  <div class="menu_list" id="secondpane"> <!--Code for menu starts here-->
		...
		<div class="menu_body">
          ...
          <a href="reporte_torta.php"><? echo "Generar Gráfico Torta"; ?></a>
          <a href="reporte_barra.php"><? echo "Generar Gráfico Barra"; ?></a>
