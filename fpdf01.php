...
$pdf->connect('localhost','root','zz','correfax');
// This is the title of the Report generated.
$attr=array('titleFontSize'=>18,'titleText'=>'MySQL Report generation using FPDF');
$pdf->Ln(10);
// This is your query. It should be a 'SELECT' query.
// Reports are run over 'SELECT' querires generally.
$pdf->mysql_report("SELECT nom_adh, date_crea_adh FROM gac_correspondencia ",false,$attr);
?>
